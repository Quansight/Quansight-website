  ...
  <div className="col-span-2 flex flex-col sm:col-span-1">
    ...
    {buttonText && buttonLink && (
      <Link
        ...
        className="order-1 mb-12 flex w-full items-center justify-center border-2 border-black py-4 px-12 text-[1.6rem] font-bold leading-[3.7rem] sm:order-3 sm:mt-12 sm:mb-0 xl:border-white"
      >
        {buttonText}
