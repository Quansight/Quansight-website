...
type TeaserColor = 'green' | 'violet' | 'pink';
...
export const Teaser: FC<TeaserProps> = ({
  ...
  <div className="relative max-w-layout mx-auto my-[6rem] lg:my-[7.6rem]">
    ...
    >
      <h2 className="w-full max-w-[440px] mb-[6.4rem] font-extrabold text-[4rem] leading-[4.9rem] lg:mb-[2.6rem] lg:text-[4.8rem]">
        {title}
      </h2>
      ...
      <div className="w-full text-center lg:absolute lg:w-2/5 lg:top-1/2 lg:right-32 lg:-translate-y-1/2">
        <Picture src={image} alt={imageAlt} width={563} height={379} />
      </div>
      {buttonText && link && (
