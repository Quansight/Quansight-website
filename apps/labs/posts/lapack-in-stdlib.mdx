...
<figure>
  <img src="/posts/lapack-in-stdlib/lapack_vs_ndarray_conventions.png" alt="Diagram illustrating the generalization of LAPACK strided array conventions to non-contiguous strided arrays" style={{position:'relative',left:'25%',width:'50%'}}/>
  <figcaption>
