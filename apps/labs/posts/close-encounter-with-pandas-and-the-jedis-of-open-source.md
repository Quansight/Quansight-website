...
category:
  [Community, Developer workflows, OSS Experience, PyData ecosystem, Internship]
featuredImage:
...
Rodríguez-Guerra](https://github.com/jaimergp) as Jaime, and [Melissa Weber
Mendonça](https://github.com/melissawm) as Melissa.
...
communicating rather than writing code. But luckily "_being a developer is more
than just typing code_", paraphrasing Melissa's comment when I made a
...
_—-pudb_ flag when calling the program and have access to all those information.
Awesome!😎
...
rhyme"_](https://www.youtube.com/watch?v=yFqFLo_bYq0).😉
