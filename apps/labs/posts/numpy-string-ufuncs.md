...
writing ufuncs for _all_ the string operations began.
...
written into the `out` array, and _that_ array will be returned. In that case, the `out`
...
[^1]:
    In reality, the string ufuncs look similar to this, but have some differences.
