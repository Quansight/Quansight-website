...
![Screenshot of the graphical interface of the napari application, freshly launched on macOS.](/posts/napari-conda-constructor-menuinst/napari-empty.png)
...
![Screenshot of the Windows graphical installer produced by constructor, customized for napari.](/posts/napari-conda-constructor-menuinst/napari-windows-installer.png)
...
![Screenshot of macOS' Launchpad. The napari icon can be seen in the bottom right corner, as one more application in the system menu.](/posts/napari-conda-constructor-menuinst/napari-icon-on-macos.png)
...
![Screenshot of the graphical interface of the napari plugin manager dialog, on macOS.](/posts/napari-conda-constructor-menuinst/napari-plugin-manager.png)
