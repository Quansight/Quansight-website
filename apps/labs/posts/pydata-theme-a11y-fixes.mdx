---
title: 'PyData Sphinx Theme Accessibility Fixes, Before and After"
...
# PyData Sphinx Theme Accessibility Fixes, Before and After
...
elements, the link and the expand/collapse icon, as completely separate. This
led to a new, slightly different markup structure, which allows the toggle
button to be focussed separately from the section link:
...
particular unconventional presentation is okay. I think it may come across as
somewhat confusing to screen reader users the first time they encounter it,
but I also think the context will quickly make things clear.
...
If you write online content, part of your accessibility story will reside in the
authoring tools you choose (tools like PyData Sphinx Theme), but some part of it
is going to be more directly in your hands, in how you present and structure
your content. There are a number of things that I did in writing this blog post
