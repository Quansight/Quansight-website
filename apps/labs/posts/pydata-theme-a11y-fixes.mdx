---
title: 'Accessibility Before and After: Transforming the PyData Sphinx Theme'
...
# Accessibility Before and After: Transforming the PyData Sphinx Theme
...
use it, including the ones featured in the [PST
