...
Sphinx-generated docs site. But one of our user-contributors, Michael Wisely,
[reported the missing search
highlight](https://github.com/pydata/pydata-sphinx-theme/issues/1676) on GitHub.
Then maintainer Daniel McCloy connected the dots. The fix was fortunately
...
This section assumes some knowledge of HTML and CSS.
...
expert. Here I would like to a give a big shout out to Eric Bailey. Some time
...
With the help of my designer partner in crime, Smera Goel, we decided that we
