...
featuredImage:
  ...
  alt: 'A Black person with short, thick hair and prescription glasses sits at an organized workstation, using a magnification app to navigate a webpage. Their posture is proper and relaxed. On the desk: a computer, a mouse, a large desk lamp and a small notebook.'
hero:
...
In some places where there were focus rings that were broken or did not meet
...
The featured image for this blog post was used with permission ([CC BY
4.0](https://creativecommons.org/licenses/by/4.0/)) from the [Disabled and
Here](https://affecttheverb.com/disabledandhere) project. Image credit: [**Sherm
for Disabled And Here.**](https://affecttheverb.com/gallery/disabledandhere/magnificationapp/)
