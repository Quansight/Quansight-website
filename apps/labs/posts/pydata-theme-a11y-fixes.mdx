...
The illustration used as featured image for this blog post was used with permission ([CC BY
...
for Disabled And
Here.**](https://affecttheverb.com/gallery/disabledandhere/magnificationapp/)
