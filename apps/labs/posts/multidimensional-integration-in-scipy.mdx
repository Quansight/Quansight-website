...
hero:
  imageSrc: /posts/multidimensional-integration-in-scipy/subdivisions-in-higher-dimensions-hero.png
  imageAlt: >
...
&\\mathbf f(\\pmb x) = [f_1(x_1, \\ldots, x_n), \\ldots,  f_m(x_1, \\ldots, x_n)] \\\\\\\\
\\int &\\mathbf f(\\pmb x) \\text d\\pmb x = \\left[\\int f_1(\\pmb x) \\text d\\pmb x, \\ldots, \\int f_m(\\pmb x) \\text d\\pmb x\\right]
\\end\{aligned\}
$$
...
<video controls>
  <source
    ...
    type="video/mp4"
  />
  <track kind="subtitles" src="/posts/multidimensional-integration-in-scipy/refining-trapezoid-rule.vtt" srcLang="en" />
</video>
...
<video controls>
  <source
    ...
    type="video/mp4"
  />
  <track kind="subtitles" src="/posts/multidimensional-integration-in-scipy/subdivisions-in-higher-dimensions.vtt" srcLang="en" />
</video>
