...
Python. In this blog post, wel'll walk-through of the current feature set and API,
and then move on to current developments and how it compares to __array_function__."
...
blogpost](https://labs.quansight.org/blog/uarray-intro/), there
...
[`__array_function__`](https://www.numpy.org/neps/nep-0018-array-function-protocol.html).
