...
**Ralf:** It was a combination of things. There were a few developers from other libraries that I knew personally. [We have a large team working on PyTorch at Quansight](/pytorch-services). Then, there were other libraries where I didn’t know anyone from, like TensorFlow or JAX. TensorFlow, for instance, is a large team at Google, but they tend to be a bit more insular, so that required active outreach to find someone and connect to the right person on that team.
