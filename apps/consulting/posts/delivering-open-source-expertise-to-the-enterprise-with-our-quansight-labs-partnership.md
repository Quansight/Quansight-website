---
title: 'Delivering Open Source Expertise to the Enterprise With Our Quansight Labs Partnership'
...
_Three approaches to a common goal: A thriving open source ecosystem that helps organizations make better data-derived decisions._
...
To see the complete list of project highlights, read the [Quansight Labs Annual Report 2023](https://labs.quansight.org/blog/labs-annual-report-2023). At a high level here’s some of what the Labs team accomplished last year:

- [PyTorch](https://pytorch.org/) 2.0 and TorchVision 0.15 included a complete revamp of the augmentation pipelines that now natively support object detection, semantic and instance segmentation, and more through the same interface.
- The CPython team released [Python 3.12](https://www.python.org/downloads/release/python-3120/) with better and more flexible f-strings (PEP 701).
- [PyTorch](https://pytorch.org/)-Ignite’s Code-Generator web application enhanced the code templates and added a Nebari integration.
- The [Data APIs consortium](https://data-apis.org/) launched and created an initial RFD for the DataFrame API standard, for cross-dataframe collaboration in the PyData ecosystem.
- [conda 23.10 adopted conda-libmamba-solver](https://conda.org/blog/2023-11-06-conda-23-10-0-release/) as the new default solver, dramatically reducing solver times for all conda users.
- conda-forge created a [Streamlit app](https://conda-metadata-app.streamlit.app/?q=conda-forge) to stream and serve conda package metadata online.
...
- Thanks to ongoing funding from the [Chan Zuckerberg Initiative (CZI) and the Space Telescope Science Institute (STScI)](https://jupyter-accessibility.readthedocs.io/en/latest/funding/index.html), the Jupyter Accessibility project, which includes several Labs members, continued to raise awareness around accessibility and to make Jupyter tools more accessible.
...
_Together we’re advancing the open source software underlying over 90% of today’s critical technology._
...
- After seeing certain problems surface time and again on client projects, Quansight’s engineers created three open source projects, two of which are now community-led, to serve both the community and our clients:
  ...
  - [Ragna](https://ragna.chat/en/stable/), an open source RAG-based AI orchestration framework designed to scale from research to production.
