...
Graphics Processing Units (GPUs) have become increasingly expensive and difficult to obtain, particularly in cloud environments. With the rise of AI applications like OpenAI’s ChatGPT, demand for powerful GPUs such as a100s and h100s has surged, making them even more costly. At [Quansight](https://quansight.com/), we work with clients who face challenges accessing these high-end GPUs on platforms like Amazon Web Services and Google Cloud Platform (GCP).
...
We will walk through a typical workflow, from initial experimentation in [Jupyter](https://quansight.com/jupyter-technologies/) to a pipeline running models on multiple GPU resources (via [Argo](https://argoproj.github.io/workflows/) Workflows) for evaluation of resource efficiency and code profiling, all with minimal code in Python. This workflow will be demonstrated on [**Nebari**](https://www.nebari.dev/), a new open source data science platform that provides scalable CPU & GPU compute and common data science tools on the cloud of your choice with minimal cloud expertise.
