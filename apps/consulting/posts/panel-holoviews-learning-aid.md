...
category: [Training, Data Visualization]
featuredImage:
...
If running in JupyterLab, run jupyter labextension install @pyviz/jupyterlab_pyviz in the terminal to install the needed labextension if you didn't above. This is not needed if running in a Jupyter notebook outside of JupyterLab.

Run import panel as pn and pn.extension() at the top of the notebook.
...
If you liked this article, check out this Panel article as well!
