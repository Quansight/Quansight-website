  ...
  return (
    ...
    >
      <button
        ...
        className={clsx(
          'relative w-full border-2 border-gray-300 bg-gray-200  py-[0.8rem] px-[1.2rem] text-center text-[1.4rem] font-normal uppercase leading-[3rem] sm:w-[26rem]',
      ...
      >
        ...
        <span
          className={clsx(
            'border-x-solid border-l-solid absolute top-1/2 right-[1rem] inline-block h-0 w-0 translate-y-[-50%] border-x-8 border-t-8 border-x-transparent',
            isDropdownOpen
              ? 'border-violet -rotate-180'
              : 'rotate-0 border-gray-300',
            filterMenuVariant === FilterMenuVariant.Category &&
              'sm:translate-y-none sm:relative sm:top-0 sm:right-0',
          )}
        />
      </button>
