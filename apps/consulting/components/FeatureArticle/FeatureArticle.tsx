...
export const FeatureArticle: FC<TFeatureArticleProps> = ({
  ...
  return (
    <article className="grid grid-rows-[auto,auto,auto] gap-x-12 gap-y-14 py-24 pr-20 pl-8 mx-auto sm:grid-cols-[1fr,1fr] sm:grid-rows-[auto,1fr] sm:px-16 lg:grid-cols-[3fr,2fr] xl:grid-cols-[0.58fr,0.75fr] max-w-layout">
